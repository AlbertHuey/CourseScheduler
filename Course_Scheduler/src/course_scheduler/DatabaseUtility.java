...
public class DatabaseUtility {
    ...
    public void removeProfessor(Teacher prof)
    {
        try{
            ...
            String sql = "delete from PROFESSORS where PROF_ID = "+ prof.id+", SEMESTER = '"+currentSemester+"'";
            PreparedStatement ps = con.prepareStatement(sql);
            ps.executeUpdate();

            //remove from COURSES
            String sql3 = "update COURSES set PROFESSOR = "+ null +" "
                    + "where PROFESSOR = '"+ prof.name +"', SEMESTER = '"+currentSemester+"'";
    ...
    public void alterProfessor(Teacher prof)
    {
        ...
        try{
            ...
            String sql = "update PROFESSORS set values(?,?,?,?, ?,?,?,?, ?,?,?,?) "
                    + "where PROF_ID = "+prof.id+", SEMESTER = '"+currentSemester+"'";      
            PreparedStatement ps = con.prepareStatement(sql);
            ps.setString(1,  currentSemester);
            ps.setInt   (2,  prof.id);
            ps.setString(3,  prof.name);
    ...
    public void removeCourse(Course course)
    {
        try{
            ...
            String sql = "delete from COURSES where CRN = " + course.crn +", SEMESTER = '"+currentSemester+"'";
            PreparedStatement ps = con.prepareStatement(sql);
            ps.executeUpdate();
            ...
            for (int i = 1; i < 9; i++){
                String sql2 = "update PROFESSORS set COURSE_"+ i +" = "+null+" "
                        + "where COURSE_"+ i +" = '"+ course.name +"',  SEMESTER = '"+currentSemester+"'";
                PreparedStatement ps2 = con.prepareStatement(sql2);
                ps2.executeUpdate();
            }
            con.close(); 
    ...
    public void alterCourse(Course course)
    {
        try{
            ...
            String sql =  "update COURSES set values(?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?)"
                        + "where CRN = " + course.crn +", SEMESTER = '"+currentSemester+"'";
            PreparedStatement ps = con.prepareStatement(sql);
            ps.setString(1, currentSemester);
            ps.setInt   (2, course.crn);
    ...
    public void removeClassroom(Classroom classroom)
    {
        try{
            ...
            String sql = "delete from CLASSROOMS where ROOM_NUM = '" + classroom.getRoomNum() +"', SEMESTER = '"+currentSemester+"'";
            PreparedStatement ps = con.prepareStatement(sql);
            ps.executeUpdate();

            //remove from COURSES
            String sql2 = "update COURSES set CLASSROOM = "+null+" where CLASSROOM = '"+ classroom.getRoomNum() +"', SEMESTER = '"+currentSemester+"'";
            PreparedStatement ps2 = con.prepareStatement(sql2);
            ps2.executeUpdate();
    ...
    public void alterClassroom(Classroom classroom)
    {
        try{
            ...
            String sql = "update CLASSROOMS values(?,?,?,?) where ROOM_NUM = " 
                    + classroom.getRoomNum() + ", SEMESTER = '"+currentSemester+"'";
            PreparedStatement ps = con.prepareStatement(sql);
            ps.setString(1, currentSemester);
            ps.setString(2, classroom.getRoomNum());
            ps.setString(3, classroom.getBuildingName());
